...
#ifndef WALLETAPP_SWIFT_H
#define WALLETAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WalletApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9WalletApp28AddTransactionViewController")
...
@interface AddTransactionViewController (SWIFT_EXTENSION(WalletApp)) <UIPickerViewDataSource, UIPickerViewDelegate>
...
SWIFT_CLASS("_TtC9WalletApp11AppDelegate")
...
SWIFT_CLASS("_TtC9WalletApp13SceneDelegate")
...
- (IBAction)cardsButtonTapped:(UIButton * _Nonnull)sender;
- (IBAction)filterChanged:(UISegmentedControl * _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
